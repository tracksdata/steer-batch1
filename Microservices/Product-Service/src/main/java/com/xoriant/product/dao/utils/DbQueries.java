package com.xoriant.product.dao.utils;
...
public class DbQueries {
	...
	public static final String FILTER_PRODUCTS_BY_BRAND="select * from products p inner join  brands b ON p.product_brand=b.brand_id where b.brand_name like ?";
